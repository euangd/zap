...
settings-agent-providers-auth-login-description = Codex または Copilot でログインして、管理対象プロバイダーを追加します。トークンはプロバイダーごとにシステムキーチェーンへ保存されます。
settings-agent-providers-auth-login-codex-title = Codex Auth
settings-agent-providers-auth-login-codex-description = Codex OAuth フローを開き、Codex プロバイダーを追加します。
settings-agent-providers-auth-login-codex-login = Codex でログイン
settings-agent-providers-auth-login-copilot-title = Copilot Auth
settings-agent-providers-auth-login-copilot-description = GitHub のデバイスログインフローを開始し、コードをクリップボードにコピーしてブラウザを開きます。コードは自動入力されません。
settings-agent-providers-auth-login-copilot-login = Copilot でログイン
settings-agent-providers-auth-login-managed-secret = 認証ログインによって管理されています。トークンはシステムキーチェーンに保存されます。
settings-agent-providers-copilot-login-code-toast = Copilot 認証コードをクリップボードにコピーしました: { $code }。ブラウザで認証ページが開いたら手動で貼り付けてください。
settings-agent-providers-copilot-login-failed-toast = Copilot ログインに失敗しました: { $error }
